...
// We use the sieve of Eratosthenes to reduce the time complexity
void sieve() {
...
// Function that will return the nearest prime to a number, greater than the number if bullion == 1
